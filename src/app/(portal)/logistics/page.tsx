      ...
      <MotionItem>
        <AiInsightCard title="Оптимальное время покупки">
          <div className="space-y-1.5 text-sm">
            <p>
              Покупка авиабилетов за <strong>5+ дней</strong> до вылета экономит в среднем{" "}
              <strong>81 000–162 000 сум (−15–22%)</strong> по данным за последние 6 месяцев.
            </p>
            <p>
              Ж/Д билеты стабильны: отклонение цены не превышает 5% независимо от даты покупки.
              Автобус — наиболее предсказуемый вариант.
            </p>
            <p>
              <strong>Рекомендация:</strong> ближайшие 2 смены (10–24 апреля) —
              покупать авиабилеты не позднее <strong>5 апреля</strong>.
              Потенциальная экономия: <strong>до 324 000 сум</strong> на 2 оператора.
            </p>
          </div>
        </AiInsightCard>
      </MotionItem>
