      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-6">
          {navGroups.map((group) => (
            <div key={group.label}>
              {!collapsed && (
                <p className="px-3 mb-2 text-[10px] uppercase tracking-widest text-slate-500">
                  {group.label}
                </p>
              )}
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "bg-white/10 backdrop-blur-sm border-l-2 border-blue-400 text-white"
        ...
        {!collapsed && (
          <div className="px-5 py-4 border-t border-white/10">
            <p className="text-[10px] text-slate-500 uppercase tracking-wider">Etive Neft Oil</p>
            <p className="text-xs text-slate-400 mt-0.5">v1.0 Demo</p>
          </div>
        )}
      </aside>
    </>
